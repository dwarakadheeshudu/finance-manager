...
import { Lock, Mail, AlertCircle, RefreshCw, Sparkles } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-[radial-gradient(circle_at_bottom_left,_rgba(255,182,193,0.18),_transparent_45%),radial-gradient(circle_at_top_right,_rgba(255,204,213,0.15),_transparent_45%),#ffffff] px-4 font-sans relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-extrabold text-gradient tracking-tight">SmartFinance AI</h2>
          <p className="mt-2 text-sm text-slate-500 font-semibold tracking-wide">Log in to manage your budgets and AI predictions</p>
        </div>
        ...
        <div className="glass-card rounded-3xl p-8 border border-pink-100/80 shadow-xl bg-white/80">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400 group-focus-within:text-pink-550 transition-colors">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className="block text-xs font-bold text-slate-650 uppercase tracking-wider">Password</label>
              </div>
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400 group-focus-within:text-pink-555 transition-colors">
          ...
          <div className="mt-8 text-center border-t border-slate-100 pt-6">
            <span className="text-sm text-slate-500 font-semibold">Don't have an account? </span>
            <Link to="/register" className="text-sm text-pink-600 hover:text-pink-700 font-bold transition-colors">
              Create an account
            </Link>
          </div>
        </div>
